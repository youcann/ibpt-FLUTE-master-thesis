...
\newcommand{\thesisreviewertwo}{Prof. Dr.-Ing. Thomas Zwick (IHE)}
...
\begin{document}
	...
	\input{chap/4-own-work-sensors/sensors.tex}
	\input{chap/5-own-work-actuators/actuators.tex}
	\input{chap/6-own-work-control-system/controlSystem.tex}
	\input{chap/9-results/results.tex}
