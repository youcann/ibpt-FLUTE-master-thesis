...
\newcommand{\thesisentopic}{Entwicklung einer Regelung zur Verbesserung der FLUTE Elektronen-Kanone}
...
\newcommand{\thesistimehandin}{16.07.2021} % on second page 'preamble'
...
\begin{document}
    ...
    \listoffigures
    \listoftables
    \clearpage\begingroup\let\newpage\relax\printglossary\endgroup
    \endgroup
    \cleardoublepage
